...
class FactionData {
  ...
  async workToJoin() {
    ...
    if (req.strLevel && req.strLevel > player.strength)
      ...
      else this.ns.spawn("/phase1/actions/companyWork.js");
...
export async function main(ns: NS) {
  ...
  if (factions.length === 0) ns.spawn("/phase1/nuke.js");
...
function getNeededFactions(ns: NS): FactionData[] {
